...
(function () {
  ...
  css += `
    ...
    /* Pepper ads */
    .aGrid[data-t="eventPromotionHeader"], /* a top banner with event promotion ads */
    .listLayout-box:has(.slot), /* a new type of ad slot on the main page */
    .box--content:has(.slot), /* a new type of ad slots on a deal details page */
    .box--content:has(.ad--bg .ad), /* new type of ad slots without a class name */
    ...
    div[data-t="voteSecondary"]:has(.vote-secondary), /* another type of the secondary vote section */
      ...
      const updateFilterStyle = event => {
        ...
        if (styleBlock.params.border) {
          ...
          if (styleBlock.params.borderStyle) {
            const borderStyleSelectElement = document.getElementById(styleBlock.params.borderStyle.id);
            borderStyle = borderStyleSelectElement.value;
            borderStyleSelectElement.parentNode.querySelector('.select-txt span').textContent = borderStyle;
